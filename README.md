...
Экспериментальным путем установили, что "пробитие" stack происходит при размере массива в 2.096.650 значений.
